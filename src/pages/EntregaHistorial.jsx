  ...
  return (
    <Container maxWidth="lg" sx={{ py: isMobile ? 2 : 4 }}>
      ...
      {deliveredOrders.length > 0 ? (
        ...
        <Typography variant="h5" align="center" color="text.secondary">No hay pedidos entregados en el historial.</Typography>
      )}
    </Container>
  );
};
